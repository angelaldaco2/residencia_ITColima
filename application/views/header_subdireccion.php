...
<body style="background-color: #fafafa;">
    ...
    $(function(){
        $('.mdl').on('click', function(){
            ...
            $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>/subdireccion/sel_carrera",
                data:{
                    id:id,
                },
			...
			<div id="nav">
				<div id="nav-bar">
					<ul class="nav navbar-nav navbar-left">
						<li><a href="<?php echo base_url('subdireccion/solicitudes') ?>">Pendientes</a></li>
						<li><a href="<?php echo base_url('subdireccion/aceptadas') ?>">Aceptadas</a></li>
